...
include_once $this->targetDirs[3].'/src/DataFixtures/LoginFixtures.php';
...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\LoginFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\TarifsFixtures(), 'groups' => []]]);
