...
include_once $this->targetDirs[3].'/src/Entity/UserCheckers.php';
...
}, 1), ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService.php')), 'api', ($this->privates['app.user_checker'] ?? ($this->privates['app.user_checker'] = new \App\Entity\UserCheckers())));
