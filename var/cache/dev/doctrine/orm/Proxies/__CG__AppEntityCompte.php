...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'montant', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'dateDepot', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'numero', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'partenaire', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depots'];
        }
