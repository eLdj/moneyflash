 ...
 */
final class Version20190801152727 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte CHANGE numero_compte numero BIGINT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte CHANGE numero numero_compte BIGINT NOT NULL');
